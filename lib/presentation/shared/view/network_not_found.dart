...
import 'package:arh_solution_app/presentation/shared/viewmodel/network_viewmodel.dart';
...
class NetworkNotFound extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final isOffline = Get.find<NetworkController>().canShowNoInternetScreen(
        Get.currentRoute,
      );
      return isConnected
          ...
          : Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: Di.screenHeight * 0.01),
